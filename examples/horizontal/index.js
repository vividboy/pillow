...
;(function(global, P) {
  ...
  var player1Arr = [
    [83, 114, 49, 101, 125.5, 99.5, 49, 101],
    [259, 113.33333333333334, 50, 103, 123, 98.5, 50, 103],
    [434.6666666666667, 114, 53, 101, 120.5, 99.5, 53, 101],
    [610.3333333333334, 114, 56, 101, 118, 99.5, 56, 101]
  ];
  var player1Jump = [
    [77, 348.6666666666667, 67, 85, 116.5, 107.5, 67, 85],
    [270.3333333333333, 312.6666666666667, 37, 105, 131.5, 97.5, 37, 105],
    [430.3333333333333, 284, 58, 130, 121, 85, 58, 130],
    [599.3333333333334, 261, 74, 123, 113, 88.5, 74, 123]
  ];
  var j = 0;
  function drawPlayer() {
    if (shadow) {
  ...
  function drawText() {
    var _w = 400;
    var _h = 250;
    var _x = WIDTH / 2 - _w / 2 + 30;
    var _y = HEIGHT / 2 - _h / 2 + 130;
